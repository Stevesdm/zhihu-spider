package com.steve.spider;

/**
 * Created by SteveJobson on 2017/9/22.
 */
...
public class GetquestionUrlProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if(page.getUrl().regex(URL_question).match()){
            ...
            String filePath = "G:\\Steve_WorkSpace\\idea\\zhihu_spider\\src\\resource\\zhihu_images";
